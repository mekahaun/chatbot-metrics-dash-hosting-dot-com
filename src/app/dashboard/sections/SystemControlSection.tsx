...
interface AgentStatusResponse {
  ...
  agentDetails: Record<string, AgentStatus>;
  toggleableAgents: string[];
  coreAgents: string[];
  generatedAt: string;
}
...
const SystemControlSection: React.FC<SystemControlSectionProps> = ({
  selectedTimePeriod,
  setActiveSection,
}) => {
  ...
  const agentStatusApiPath = process.env.NEXT_PUBLIC_AGENT_STATUS_API_PATH;
  const agentControlApiPath = process.env.NEXT_PUBLIC_AGENT_CONTROL_API_PATH;
