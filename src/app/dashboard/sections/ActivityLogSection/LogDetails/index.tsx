...
const getSourceComponentIcon = (sourceComponent: any) => {
...
const getEventCodeIcon = (eventCode: string) => {
  switch (eventCode) {
...
export default function LogDetails(props: LogDetailsProps) {
  ...
  const handleConversationFlowClick = (flow: any) => {
        ...
        <div className="w-full flex justify-between items-start gap-x-8 p-4 bg-white z-10">
          <div>
            ...
            <div
              ...
              className="border rounded-lg bg-white shadow-sm max-h-[280px] md:max-h-[calc(90vh-220px)] overflow-y-auto relative"
            >
              <div className="p-3 border-b bg-gray-50 sticky top-0 z-[1]">
                <span className="text-xs font-medium text-gray-500">
                  Timeline (Conversation ID: {conversationId})
                </span>
              </div>
              <div className="p-2 space-y-0">
                {conversationFlows.map((flow: any, index: number) => (
